	...
	<div class="topnav ">
	 ...
	 <tr>
			...
			<td>
					...
					<input type="text" placeholder="Name or Parent ID" name="Search_ID">
			</td>
...
if (ctype_alpha( $_POST["Search_ID"]))
{
			
			
			$q2="select f.f_ID,f_name,f_cnic,f_num,f_address,f_mail,f_income,f_isalive,f_emp_ID from Father f where f.f_name = '".$_POST["Search_ID"]."'"  ;
			...
			{	
								...
								echo "<form action = \"Report_15_1.php\" method = 'post'>";
								echo "<tr>";
								//echo '<td>' . $row2[0] . '</td>';
								
								echo	'<div><b><font size="6" face="algerian" color="866684"><pre>Name:  ' .$row2[0].   '</pre></font></b></div>';
								
								//echo '<td>' . $row2[1] . '</td>';
								
								echo	'<div><b><font size="6" face="algerian" color="866684"><pre>Name:  ' .$row2[1]. '</pre></font></b></div>';
								
								echo "<input type=\"hidden\" name=\"Search_ID\" value=".$row2[0].">";
							//echo '<input type = "submit" name = "View">';
								
								
								
								 echo '<input class = "fsSubmitButton134 centered111a" type = "submit" value = "View" name = "View">';
			...
			$q2="select m.m_ID,m_name,m_cnic,m_num,m_address,m_mail,m_income,m_isalive,m_emp_ID from mother m where m.m_name = '".$_POST["Search_ID"]."'"  ;
			$query_id2 = oci_parse($con, $q2);
			$r2 = oci_execute($query_id2);
